...
using MauiStart.Models.Exceptions.Network;

namespace MauiStart.Models.Data.API.RequestProvider;
...
public class RequestProvider(HttpMessageHandler _messageHandler) : IRequestProvider
{
    ...
    private static async Task<T?> ReadFromJsonAsync<T>(HttpContent content)
    {
        ...
        var data = await JsonSerializer
            .DeserializeAsync(contentStream, typeof(T), MauiStartJsonSerializerContext.Default)
